...
export type CloudItem = { id: string; name: string; category: string; brand: string; unit: string; quantity: number; specification: string; conversion?: { amount: number; unit: string }; unitCost: number; purchasedOn: string; supplier: string; receiptCode?: string; receipt?: CloudReceipt; history: CloudHistory[] };
