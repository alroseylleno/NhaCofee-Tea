...
export default function Home() {
  ...
  function returnToStock(session: ActiveSession) {
    if (!isLocalUat || !window.confirm("Trả đơn vị này về trạng thái tồn kho? Thao tác chỉ áp dụng cho dữ liệu UAT local.")) return;
    setActiveSessions((current) => current.filter((activeSession) => activeSession.id !== session.id));
  }
