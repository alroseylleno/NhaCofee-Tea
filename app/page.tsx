...
function normalizeCategory(value: string) { return value.trim().toLocaleUpperCase("vi") || "CHƯA PHÂN LOẠI"; }
...
export default function Home() {
  ...
  }), [filteredGroups, inventoryCategory, inventoryView, activeSessions, items, inventorySort]);
