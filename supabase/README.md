...
5. Add `NEXT_PUBLIC_SUPABASE_URL` and `NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY` to `.env.local` and Vercel environment variables.
6. Create the shared shop account in Supabase Auth before enabling staff access.
